...
def login():
	...
	r = requests.post(url, headers=headers, data={'username': '13725569993', 'password': '1987611', 'rememberme': '1'},
					  verify=False)
...
def checkin():
	...
	cookies["web_ab"] = "A1"
	cookies[
		"smzdm_wordpress_360d4e510beef4fe51293184b8908074"] = "minkey%7C1476610598%7C9da7223c1f42e93184d186e115cf4513"
